...
public class StorageController implements Serializable
{
    ...
    @EJB
    private com.logisticstool.logisticstool.StorageFacade ejbFacade;
    ...
    public void create()
    {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("StorageCreated"));
    ...
    public void update()
    {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("StorageUpdated"));
    }

    public void destroy()
    {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("StorageDeleted"));
        if (!JsfUtil.isValidationFailed())
        {
    ...
    public Storage getStorage(java.lang.Integer id)
    {
